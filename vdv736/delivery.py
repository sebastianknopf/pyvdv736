...
class SiriServiceDelivery(SiriDelivery):

    def __init__(self, producer_ref: str):
        self.Siri = Element('Siri', xmlns='http://www.siri.org.uk/siri', version='2.1')
        ...
        self.Siri.ServiceDelivery.MoreData = False


class SituationExchangeDelivery(SiriServiceDelivery):
